...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, AuthenticationManager authenticationManager)
        ...
        http.csrf(csrf -> csrf.disable()) // désactivation de la vérification par défaut des attaques CSRF (pas grave
                                          // vue qu'on va mettre en place un système de jetons)
                ...
                // ajout du filtre pour la phase d'authentificaiton, utilisé uniquement lors de
                // la phase de login
                .addFilter(new CustomAuthenticationFilter(authenticationManager))

                // filtre qui va se déclencher à chaque requete juste avavant le
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:5173", "http://127.0.0.1:5173")); // Origine autorisée
