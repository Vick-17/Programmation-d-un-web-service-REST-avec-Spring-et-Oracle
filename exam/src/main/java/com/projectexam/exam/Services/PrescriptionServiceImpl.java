...
@Service
public class PrescriptionServiceImpl extends GenericServiceImpl<Prescription, PrescriptionDto, Long, PrescriptionRepository, PrescriptionMapper> implements PrescriptionService {
