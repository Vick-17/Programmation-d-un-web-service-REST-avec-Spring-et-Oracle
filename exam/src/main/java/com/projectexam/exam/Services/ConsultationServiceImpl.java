...
@Service
public class ConsultationServiceImpl extends GenericServiceImpl<Consultation, ConsultationDto, ConsultationRepository, ConsultationMapper> implements ConsultationService {
